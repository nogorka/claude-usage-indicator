...
- [ ] **Шаг 8.3: Прогнать питоновский набор**
...
- [ ] **Шаг 9.2: Изменить сборку содержимого**
...
- [ ] **Шаг 9.3: Прогнать полный питоновский набор**
...
- [ ] **Шаг 10.1: Написать падающий тест**
...
- [ ] **Шаг 10.2: Прогнать и убедиться, что падает**
...
- Миграций нет.
- Покрытие не измеряется: `coverage` в системе отсутствует, а установка нарушила бы
  «внешних зависимостей не добавлять» из «Глобальных ограничений». Требование 80% из
  спеки остаётся открытым вопросом к владелице — см. последнюю строку «Рисков».
...
| Покрытие от 80% | Критерий 7 спеки и инженерный минимум его требуют, план его не измеряет: `coverage` в системе нет, а установка нарушила бы запрет на новые зависимости | **Не закрыто.** Вопрос вынесен владелице: тестовая зависимость, stdlib `python3 -m trace --count` как грубый суррогат, или снять критерий с записанной причиной |
