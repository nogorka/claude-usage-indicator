...
- [x] Готово, когда меню трея несёт по пункту «Open Claude — …» на каждый найденный на
...
- [x] **Шаг 8.1: Зафиксировать текущее поведение (RED руками)**
...
- [x] **Шаг 8.4: Ручная проверка (GREEN руками)**
...
Выполнено 11.09.2026 на живом дисплее: RED снят с worktree на коммите до правки,
GREEN — на настоящем GTK с подложенным `HOME`; переменные до оболочки доходят,
проверено настоящим `gnome-terminal` с `printenv` вместо `claude`.
...
- [x] **Шаг 9.1: Зафиксировать текущее поведение (RED руками)**
...
- [x] **Шаг 9.4: Ручная проверка (GREEN руками)**
...
Выполнено 11.09.2026 на живом дисплее: обе секции на месте, у просроченного окна `0%`
и текст «window reset at …».
