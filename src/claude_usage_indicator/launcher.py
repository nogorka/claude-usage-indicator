...
действует только на запускаемый процесс, так что сессии разных профилей не делят
состояние друг с другом. Решение, куда идти, принимает человек — автоматической
подмены нет.
"""
